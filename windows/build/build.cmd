...
if "%locale%"=="ru" (
	echo ùùù? I2Pd Browser Portable
	echo ùùù ùù?ù: %locale%, ùùù?ùùù: %xOS%
	echo.
	echo ùùùù?ù ùù?ùù?ù Firefox ESR
) else (
...
echo.
if "%locale%"=="ru" (
	echo ùù?ùùùùù ùù?ùù?ù ù ?ùùùùù ùù ù?ùù ?ùùù
) else (
...
echo.
if "%locale%"=="ru" (
	echo ùùù? ùùùù?ùùù ?ùù ùù?ù ùùù ù?ù?ùù ùùùù?ùù ùùùù?
) else (
...
echo.
if "%locale%"=="ru" (
	echo ùùùù?ù ùùùùùùùùùù NoScript
) else (
...
echo.
if "%locale%"=="ru" (
	echo ùùùù?ùùùù ?ùùù ùùùù?ù ù ùùùùù Firefox
) else (
...
echo.
if "%locale%"=="ru" (
	echo I2Pd Browser Portable ùù? ù ùùùùùù!
) else (
